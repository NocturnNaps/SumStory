...
//                 room.ActualLeftDoor.otherDoor = ThisRoom.RightDoor;
//                 room.ActualLeftDoor.CameraPosition = ThisRoomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
...
//                     new Vector3(ThisRoomObject.transform.position.x - DistanceBetweenRooms, ThisRoomObject.transform.position.y, 0));
//                 room = roomObject.GetComponent<Room>();
//                 room.ActualRightDoor.otherDoor = ThisRoom.LeftDoor;
//                 room.ActualRightDoor.CameraPosition = ThisRoomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
//                 CameraPosition = roomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
//                 otherDoor = room.RightDoor;
//             }
//             else if (UpperEnter)
...
//                 room = roomObject.GetComponent<Room>();
//                 room.ActualDownDoor.otherDoor = ThisRoom.UpperDoor;
//                 room.ActualDownDoor.CameraPosition = ThisRoomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
//                 CameraPosition = roomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
//                 otherDoor = room.DownDoor;
//             }
//             else if (DownEnter)
...
//                     new Vector3(ThisRoomObject.transform.position.x, ThisRoomObject.transform.position.y - DistanceBetweenRooms, 0));
//                 room = roomObject.GetComponent<Room>();
//                 room.ActualUpperDoor.otherDoor = ThisRoom.DownDoor;
//                 room.ActualUpperDoor.CameraPosition = ThisRoomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
//                 CameraPosition = roomObject.transform.position + new Vector3(10.98495f,-2.89f,-149.2843f);
//                 otherDoor = room.UpperDoor;
//             }
//         }
